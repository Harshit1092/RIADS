...
export const TOP = () => {
   return (
      <div className='bg-[#c54545] text-white px-5'>
         <div className="row align-items-center">
               ...
               <ul className="left-info ">
                  <li>
                     <a className='no-underline text-white' href="mailto:riads.rupnagar@gmail.com">
                        ...
                        <span >riads.rupnagar@gmail.com</span>
                     </a>
                  </li>
                  <li>
                     <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="col-sm-8">
               <marquee><b>Rupnagar Institute Of Automotive and Driving Skills</b> In Association with District Red Cross Society, Rupnagar</marquee>
            </div>
         </div>
      </div>
   )
