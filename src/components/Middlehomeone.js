                ...
                <div className="row">
                    <div className="col-md-8 offset-md-2 mb-5">
                        ...
                        <div className="text-center bg-white">
                            ...
                            <p className='font-light'>The objective of the course is to develop a fresh cadre of high-quality drivers to meet the demand of the transport industry and make local youths employable by..</p>
