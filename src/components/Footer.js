    ...
    return (
        <footer
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="">
                        ...
                        <p>
                            With the sincere efforts, far-sighted vision and progressive mission of Sh Bhagwant Mann – the worthy Chief Minister of Punjab; "RUPNAGAR INSTITUTE OF AUTOMOTIVE &amp; DRIVING SCHOOL"
                        </p>
                    </div>
            ...
            <div class="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
                <span>© 2023 Copyright Rupnagar Institute of Automotive & Driving Skills. Managed by </span>
                <a
                    class="font-semibold text-neutral-600 dark:text-neutral-400"
                    href="https://tailwind-elements.com/"
                >Smart Info Technology</a
                >
            </div>
        </footer>
    )
