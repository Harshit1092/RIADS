    ...
    function handleSubmit(e) {
        ...
        for (let i = 0; i < randomQuestions.length; i++) {
            try {
                ...
                const correct_option = questions_eng.find((question) => question.QuestionId === randomQuestions[i]).Correct_option;
                // get value of correct option
                const correct_option_value_eng = questions_eng.find((question) => question.QuestionId === randomQuestions[i]).Options[correct_option];
                console.log(correct_option_value_eng);

                const correct_option_value_punj = questions_punj.find((question) => question.QuestionId === randomQuestions[i]).Options[correct_option];
                ...
                console.log("-------------")
                if (answers[randomQuestions[i]] === correct_option_value_eng || answers[randomQuestions[i]] === correct_option_value_punj) {
                    score++;
                }
            }
            catch (e) {
          ...
          <Sidebar isSidebar={isSidebar} />
                ...
                <div className='w-full flex flex-col'>
                    ...
                    <TestForm
                        ...
                        data={language === 'English' ? questions_eng[questionCounter] : questions_punj[questionCounter]}
                    />
